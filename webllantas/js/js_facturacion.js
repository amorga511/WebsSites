...
appM.controller('appControl1', function($scope,$http) {
    ...
    $scope.search_facs = function(){
        ...
        $http.post('http://192.168.0.254/webllantas/server/svrConsultas.php', {op:106, tipo:$scope.vCriterioSearchF, fini:vDate1, ffin:vDate2, crit:$scope.vNumFac_find}).then(function(vResult){
            //alert(vResult.data),
